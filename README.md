ansible_role_vnc_desktop
=========


[![CI](https://github.com/habbis/ansible_role_vnc_desktop/workflows/CI/badge.svg)](https://github.com/habbis/ansible_role_vnc_desktop/actions?query=workflow%3ACI)
...
```
find . -type f -print0 | xargs -0 sed -i "s/ansible_role_vnc_desktop/new_role/g"
...
```
find . -type f -print0 | LC_ALL=C  xargs -0  sed -i "" 's/ansible_role_vnc_desktop/new_role/g'
```
